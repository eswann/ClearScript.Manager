...
namespace ClearScript.Manager.Caching
{
    ...
    public interface IDictionaryEx<TKey, TValue> : IDictionary<TKey, TValue>, IDisposable
    {
        ...
        TValue GetOrAdd([NotNull] TKey key, TValue value);
        ...
        /// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.IDictionary`2"/> is read-only.</exception>
        bool TryAdd([CanBeNull] TKey key, TValue value);
        ...
        /// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.IDictionary`2"/> is read-only.</exception>
        bool TryUpdate([CanBeNull] TKey key, TValue value);
        ...
        /// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.IDictionary`2"/> is read-only.</exception>
        bool TryUpdate([CanBeNull] TKey key, TValue value, TValue comparisonValue);
        ...
        /// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.IDictionary`2"/> is read-only.</exception>
        bool TryRemove([CanBeNull] TKey key, out TValue value);
    }
}